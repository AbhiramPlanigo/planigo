  ...
  return (
    <section id="features" className="py-32 px-4 bg-[#030014] border-y border-white/5 relative scroll-mt-24 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
        ...
        {/* Localized Glows */}
        <div className="absolute top-1/4 -left-20 w-[400px] h-[400px] bg-planigo-indigo/10 blur-[100px] rounded-full"></div>
        <div className="absolute bottom-1/4 -right-20 w-[400px] h-[400px] bg-planigo-orange/5 blur-[100px] rounded-full"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-24">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[10px] font-black uppercase tracking-[0.2em] text-planigo-pink mb-6">
            <span className="w-1.5 h-1.5 rounded-full bg-planigo-pink animate-pulse"></span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {FEATURES.map((feature, idx) => (
            ...
            >
              {/* Card Hover Glow */}
              <div className="absolute inset-0 bg-gradient-to-br from-planigo-indigo/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

              <div className="relative z-10">
                <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-8 group-hover:scale-110 group-hover:bg-planigo-indigo/10 group-hover:border-planigo-indigo/30 transition-all duration-500">
                  ...
                  {React.isValidElement(feature.icon) && React.cloneElement(feature.icon as React.ReactElement<any>, {
                    className: "w-7 h-7 text-white/60 group-hover:text-planigo-pink transition-colors"
                  })}
                </div>
