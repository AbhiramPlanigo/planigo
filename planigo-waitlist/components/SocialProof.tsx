  ...
  return (
    <section className="py-24 px-4 relative overflow-hidden bg-[#030014]">
      ...
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
        {/* Large Faint Radial Glows */}
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-indigo-600/5 blur-[120px] rounded-full translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-purple-600/5 blur-[120px] rounded-full -translate-x-1/2 translate-y-1/2"></div>
        ...
        <div className="absolute top-[20%] left-[10%] w-1.5 h-1.5 bg-purple-500 rounded-full blur-[2px] animate-pulse"></div>
        <div className="absolute top-[60%] right-[15%] w-1.5 h-1.5 bg-orange-500 rounded-full blur-[2px] animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-[30%] left-[25%] w-1.5 h-1.5 bg-cyan-500 rounded-full blur-[2px] animate-pulse" style={{ animationDelay: '2s' }}></div>
        
        {/* Faint Grid Segment */}
        <div className="absolute bottom-0 left-0 w-full h-1/2 opacity-[0.05]" 
             style={{ 
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[10px] font-black uppercase tracking-[0.2em] text-orange-400 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {ROUTES.map((route, idx) => (
            <div key={idx} className="relative group rounded-[2.5rem] overflow-hidden aspect-video border border-white/10 shadow-2xl shadow-black/50">
              ...
              {/* Status Badge */}
              <div className="absolute top-6 right-6 px-4 py-2 bg-purple-600 rounded-full shadow-[0_0_20px_rgba(147,51,234,0.5)]">
