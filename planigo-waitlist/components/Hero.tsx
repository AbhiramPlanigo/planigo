...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-32 px-4 overflow-hidden grid-background">
      {/* Premium Badge */}
      <div className="relative z-10 mb-8 flex items-center gap-2 px-5 py-2 rounded-full glass-card border-white/10 text-white/80 text-[10px] font-black uppercase tracking-[0.3em] hover:bg-white/5 transition-all cursor-default group">
      ...
      <div className="relative z-10 text-center w-full max-w-6xl mx-auto flex flex-col items-center">
        ...
        <div className="mb-4 group">
          <div className="p-6 glass-card rounded-[2.5rem] shadow-[0_0_60px_-15px_rgba(99,102,241,0.2)] animate-float border-white/10">
        ...
        <div className="relative mb-8 group brand-title-group select-none w-full flex flex-col items-center">
          ...
          <div className="absolute inset-0 blur-[120px] bg-indigo-500/10 -z-10 group-hover:bg-indigo-500/30 transition-all duration-700"></div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 md:gap-x-6 text-2xl md:text-5xl font-[1000] uppercase tracking-tighter">
            ...
            <div className="neon-badge-wrapper group">
              ...
              <div className="neon-badge-content">
                <MousePointer2 className="w-6 h-6 md:w-8 md:h-8 text-orange-500 group-hover:scale-110 transition-transform" />
