...
const TripPreview: React.FC = () => {
  const items = [
    { icon: <Bus size={20} />, label: 'Volvo A/C Sleeper', price: '₹3,500', color: 'text-cyan-400' },
    { icon: <Home size={20} />, label: 'Stay (2 Nights)', price: '₹4,200', color: 'text-purple-400' },
    { icon: <Bike size={20} />, label: 'Scooty Rental (48h)', price: '₹1,200', color: 'text-orange-400' },
    { icon: <Utensils size={20} />, label: 'Food & Drinks Pack', price: '₹2,500', color: 'text-pink-400' },
  ];
  ...
  const floatingNodes = [
    { 
      ...
      pos: '-top-14 -left-28 md:-top-24 md:-left-48', 
      delay: '0s',
    ...
    { 
      ...
      pos: '-bottom-12 -right-24 md:-bottom-20 md:-right-40', 
      delay: '2s',
    ...
    { 
      ...
      pos: 'top-1/2 -left-36 md:-left-64 -translate-y-1/2', 
      delay: '4s',
    ...
    { 
      ...
      pos: '-top-10 -right-20 md:-top-20 md:-right-36', 
      delay: '1s',
  ...
  return (
    <div className="relative w-full max-w-3xl mt-16 mb-20 flex justify-center items-center">
      ...
      <div className="relative group w-full max-w-lg animate-float z-10">
        ...
        <div className="absolute -inset-2 bg-gradient-to-r from-orange-500/40 via-purple-600/40 to-cyan-500/40 blur-3xl opacity-30 group-hover:opacity-60 transition duration-1000"></div>
        <div className="absolute -inset-16 bg-indigo-500/10 blur-[100px] rounded-full opacity-50"></div>
        ...
        <div className="relative glass-card rounded-[2.5rem] overflow-hidden border-white/10 shadow-[0_0_120px_-20px_rgba(99,102,241,0.3)]">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <h4 className="text-lg md:text-xl font-bold text-white flex items-center gap-4">
                  Bangalore <span className="text-orange-400">→</span> Goa
                </h4>
              </div>
            </div>
          ...
          {/* Enhanced Footer */}
          <div className="p-8 bg-gradient-to-r from-orange-500/20 to-transparent flex items-center justify-between border-t border-orange-500/20">
            <div className="flex flex-col">
              <span className="text-[11px] font-black text-orange-400 uppercase tracking-[0.2em] mb-1.5">Total Optimized Cost</span>
              <div className="flex items-baseline gap-3">
                <span className="text-3xl font-black text-white">₹11,400</span>
                <span className="text-[12px] text-orange-400 font-bold italic">(-₹600 buffer)</span>
              </div>
            </div>
            <div className="px-5 py-2.5 rounded-xl bg-orange-500/10 border border-orange-500/20 text-orange-400 text-[12px] font-black uppercase tracking-[0.2em]">
              LIVE RATE
            </div>
          </div>
        </div>
